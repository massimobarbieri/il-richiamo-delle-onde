...
\author{Felix, Puppis, Stone, Victor Vega, Sam Lassen - DM: Gabbo}
\date{2023-2024}
...
Mentre Puppis distrae il ragazzo con facilità, Stone tenta di aprire la porta della stanza della madre. Trovandola chiusa a chiave sfonda la porta con il suo carapace e scopre una scena tragica: la madre si è tolta la vita, tagliandosi la gola.
...
Prima di partire i personaggi fanno scorta di provviste e Victor si cimenta nella preparazione di verdure in salamoia per conservarle per più tempo possibile. 

\section{S10 - 19/04/2025}
La navigazione prosegue senza intoppi per i primi giorni, finché, all’alba del terzo, una tempesta improvvisa si abbatte sull’imbarcazione. Colpisce solo loro, come se l’ira degli elementi fosse rivolta esclusivamente alla \textit{Giosefina}. Il mare si agita, i venti ululano, e la pioggia cade violenta. La furia della tempesta danneggia parzialmente la nave.
...
Il mattino seguente il viaggio procede nella norma, finché poco più avanti i personaggi notano una nave con le vele rosse che naviga direttamente verso di loro. 


\chapter{NPC}

\subparagraph{Dorcraes} Sacerdotessa dell'isola della Luna Nascente
