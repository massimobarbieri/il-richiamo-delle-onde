...
Torniamo da Tamara e trattiamo il prezzo di un set di carte nautiche e un portacarte; nel mentre Puppies ha preso nel molo dei pezzi per fare una canna da pesca.

Il piano è di fingere la resa per farci attaccare: possiamo far sventolare a Puppies o Victor un fazzoletto bianco, mentre gli altri membri dell'equipaggio sono nascosti e pronti ad attaccare. Dopo un momento di incertezza nella partenza ci ricordiamo che oltre a issare la vela è opportuno issare anche l'ancora e salpiamo verso Sud - Est: Puppies si apposta a osservare, Felix medita, Victor prepara i cannoni. Victor nota che i cannoni sono rotti ed esclama insulti al borgomastro.
...
Ci avviciniamo alla nave, Vicotr alza un braccio in segno di tregua e lancia un incantesimo per lasciare una scia di acqua rossa dietro di loro. La nave si avvicina, un pirata sta timonando e gli altri due non sono visibili. Le due navi sono abbastanza vicina da parlare: Victor chiede aiuto ai pirati, che gli dicono che sono le persone più pericolose della zona. Su invito di Vicotor i pirati salgono sulla nave: Fennop sta per far saltare il piano, Victor prova ad addormentare i pirati ma fallisce. Tira fuori petali e sabbia e i pirati giudicano il suo lato femminile.
...
Inizia il combattimento che porta alla morte dei 3 pirati e al danneggiamento della nave fornita dal borgomastro.
